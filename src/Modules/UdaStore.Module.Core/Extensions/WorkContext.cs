...
namespace UdaStore.Module.Core.Extensions
{
    ...
    {
        private const string UserGuidCookiesName = "UdaStoreUserGuid";
        ...
        public async Task<User> GetCurrentUser()
        {
            ...
            var dummyEmail = string.Format("{0}.guest@udastore.com", userGuid);
            ...
            var abc = await _userManager.CreateAsync(_currentUser, "Abc12345$");
